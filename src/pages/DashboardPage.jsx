...
const formatDisplayDate = (dateString) => {
  ...
  try {
    // We split the string "2025-10-01T..." to avoid timezone issues
...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchAllData = async () => {
      ...
      try {
        ...
        // Set state from the 'data' property of the API responses
  ...
  const handleAppointmentAction = async (e, appointmentId, action) => {
    ...
    try {
      ...
      // Update the appointments list in the UI without a full reload
  ...
  if (!user) { // This will catch if the user profile failed to load
    return (
      <>
        <Navbar />
        <div className="general dashboard" style={{ minHeight: '60vh' }}>
      ...
      <section className="general dashboard">
        ...
        <div className="section-card patient-card">
          ...
          <div className="patient-grid">
            ...
            {/* This uses your 'logo.svg' import */}
